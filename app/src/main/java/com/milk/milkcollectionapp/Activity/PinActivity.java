...
import com.milk.milkcollectionapp.ShowCustomToast;
import com.milk.milkcollectionapp.apicalling.WebService;
import com.milk.milkcollectionapp.apicalling.WebServiceListener;
...
public class PinActivity extends AppCompatActivity implements WebServiceListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        svContext = this;
        customToast = new ShowCustomToast(PinActivity.this);
        ...
        if (isLogin.equals("1") || isLogin.equals("2")) {
            ...
            btnVerify.setOnClickListener(v -> {
                ...
                hideSoftKeyBoard();
                PinActivity.this.runOnUiThread(() -> verifyDetailApi());
            });
    ...
    private void callWebService(String[] postUrl, Map<String, String> params) {
        WebService webService = new WebService(PinActivity.this, postUrl, params, this,
    ...
    public void onWebServiceError(String result, String url) {
        customToast.showCustomToast(PinActivity.this, result, customToast.ToastyError);
    }
}
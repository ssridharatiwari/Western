...
private Context _context;
   ...
   public void setTitle(String settitle) {
    ...
    public void setConnectedDeviceName(String settitle) {
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString("deviceid", settitle);
        editor.commit();
    }
    ...
    public void setWgDeviceName(String settitle) {
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString("deviceid_wdg", settitle);
        editor.commit();
    }

    public String geWgDeviceName() {
        if(prefs.contains("deviceid_wdg"))
            return prefs.getString("deviceid_wdg", "");
        else
            return "";
    }

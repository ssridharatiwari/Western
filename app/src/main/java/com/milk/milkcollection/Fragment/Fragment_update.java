...
public class Fragment_update extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        et_weight = (EditText) rootView.findViewById(R.id.u_weight);
        et_fat = (EditText) rootView.findViewById(R.id.u_fat);
        et_snf = (EditText) rootView.findViewById(R.id.u_snf);
        et_code = (EditText) rootView.findViewById(R.id.u_et_code);
        rate = (TextView) rootView.findViewById(R.id.u_rate);
        tv_code_holder = (TextView) rootView.findViewById(R.id.u_member);
        total = (TextView) rootView.findViewById(R.id.u_total);
        btnrate = (TextView) rootView.findViewById(R.id.u_click_rate);
        btntotal = (TextView) rootView.findViewById(R.id.u_click_total);
        tv_datepicker = (TextView) rootView.findViewById(R.id.u_date);

        sp_shift = (Spinner) rootView.findViewById(R.id.u_sp_shift);
